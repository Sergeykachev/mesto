...
const formInputName = profileForm.querySelector('.popup__input_form_name-profile');
const formInputLink = profileForm.querySelector('.popup__input_form_link-profile');
